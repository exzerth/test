        ...
        >
          <div className="modal_form_wrapper relative">
            ...
            <div className="flex flex-col justify-center items-center">
                <img className='w-[100px] h-[100px] md:w-[140px] md:h-[140px] mb-1' src={avatarImg} alt="" />
                <h2 className='font-bold text-gray20 text-base mb-1'>@instagram</h2>
                <input className='bg-[#f8f8f8] rounded-[10px] w-full md:w-[403px] placeholder:text-center py-5 md:py-6' type="text" placeholder='Instagram Password' />
